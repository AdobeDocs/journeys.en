...
If you have Adobe Campaign Standard, you need to configure the out-of-the box action to send emails, push notifications and SMS using the Adobe Campaign Standard's Transactional Messaging capabilities. Refer to [this page](../action/working-with-adobe-campaign.md#using_adobe_campaign_standard).

If you have Adobe Campaign v7 or v8, an integration is available upon request. Refer to [this page](../action/working-with-adobe-campaign.md#using_adobe_campaign_v7_v8).
