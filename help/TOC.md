...
+ Configuring an action {#action-journeys}
  ...
  + [Working with Adobe Campaign](using/action/working-with-adobe-campaig.md)
...
+ Use cases{#use-cases-journeys}
  ...
  + [Sending a message using Campaign Classic](using/usecase/campaign-v7-v8-use-case.md)
